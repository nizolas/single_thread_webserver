...
{
    struct worker_procReq_arg *worker_context = (struct worker_procReq_arg*) arg;

    queue<int> *queueConnection = worker_context->queueConnection;
    Webserver *webserver = worker_context->webserver;
    int clientFD;
...
{
    queue<int> queueConnection;
    int clientFD;
    int rc;

    struct worker_procReq_arg worker_procReq;
